...
class _homepageState extends State<homepage> {
  ...
  void check(board) {
    ...
    if (board[0][0] == 1 && board[1][0] == 1 && board[2][0] == 1) {
      res = "P1";
      dialog = Image.asset('assets/images/p1win.png');
      score.add(1);
    ...
    //__thirdrow_______________
      ...
      res = "P2";
      score.add(2);
      dialog = Image.asset('assets/images/p2win.png');
    ...
    //_________________
      ...
      if (board[0][0] != 0 &&
          ...
          board[2][2] != 0) {
        res = "Draw";
        dialog = Image.asset('assets/images/drawwin.png');
        score.add(3);
      }
    }
  }
  ...
  Widget dialog1 = Image.asset('assets/images/p1win.png');
  Widget dialog2 = Image.asset('assets/images/p1win.png');
  Widget dialog = Text("");
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        //c5
                        padding:
                            const EdgeInsets.only(top: 25, left: 7, right: 7),
                        height: 120,
                        width: 100,
                        decoration: const BoxDecoration(
                            border: Border(
